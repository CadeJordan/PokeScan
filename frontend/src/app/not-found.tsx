  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-black font-semibold">
      <div className="flex flex-col items-center w-11/12 bg-white rounded-2xl shadow-lg p-10">
        ...
        <Link
          href="/"
          className="flex bg-indigo-600 w-48 h-14 items-center justify-center rounded-2xl text-white font-semibold text-lg hover:bg-indigo-700 transition duration-200"
        >
          Go Back Home
        </Link>
